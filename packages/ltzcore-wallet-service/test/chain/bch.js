...
const { LtzcoreLibCash } = require ('crypto-wallet-core');
  ...
  describe('#getEstimatedSize', function() {
    ...
    before(function()  {
      ...
      simpleUtxoWith1BTC = {
        ...
        outputIndex: 0,
        script: LtzcoreLibCash.Script.buildPublicKeyHashOut(fromAddress).toString(),
        satoshis: 1e8,
      };

      const privKey = new LtzcoreLibCash.PrivateKey();
    ...
    it('1  input p2pkh,1 output p2pkh: Margin should be 10%  ', function() {
      ...
      // Create a similar TX.
      let tx = new LtzcoreLibCash.Transaction();
