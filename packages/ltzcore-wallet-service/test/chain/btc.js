...
describe('Chain BTC', function() {
  ...
  describe('#getLtzcoreTx', function() {
    ...
    it('should order outputs as specified by outputOrder', function() {
      ...
      var t2 = ChainService.getLtzcoreTx(txp);
      t2.getChangeOutput().should.deep.equal(t2.outputs[0]);
    });

    it('should create a valid signed ltzcore TX', function() {
    ...
    it('should create a valid unsigned ltzcore TX', function() {
      var txp = TxProposal.fromObj(signedTxp);
      var t = ChainService.getLtzcoreTx(txp, {signed: false} );
      should.exist(t);
  ...
  describe('#getEstimatedSize', function() {
    ...
    before(function()  {
      ...
      simpleUtxoWith1BTC = {
        ...
        outputIndex: 0,
        script: LtzcoreLib.Script.buildPublicKeyHashOut(fromAddress).toString(),
        satoshis: 1e8,
      };
       ...
       simpleWitnessUtxoWith1BTC = {
         ...
         outputIndex: 0,
         script: LtzcoreLib.Script.fromAddress(witnessFromAddress).toString(),
         satoshis: 1e8
       };
      const privKey = new LtzcoreLib.PrivateKey();
    ...
    it('1  input p2pkh,1 output p2pkh  ', function() {
      ...
      // Create a similar TX.
      let tx = new LtzcoreLib.Transaction();
    ...
    const p2shPrivateKey1 = LtzcoreLib.PrivateKey.fromWIF('cNuW8LX2oeQXfKKCGxajGvqwhCgBtacwTQqiCGHzzKfmpHGY4TE9');
    const p2shPublicKey1 = p2shPrivateKey1.toPublicKey();
    const p2shPrivateKey2 = LtzcoreLib.PrivateKey.fromWIF('cTtLHt4mv6zuJytSnM7Vd6NLxyNauYLMxD818sBC8PJ1UPiVTRSs');
    const p2shPublicKey2 = p2shPrivateKey2.toPublicKey();
    const p2shPrivateKey3 = LtzcoreLib.PrivateKey.fromWIF('cQFMZ5gP9CJtUZPc9X3yFae89qaiQLspnftyxxLGvVNvM6tS6mYY');
    const p2shPublicKey3 = p2shPrivateKey3.toPublicKey();

    const p2shAddress = LtzcoreLib.Address.createMultisig([
      p2shPublicKey1,
      p2shPublicKey2,
//      p2shPublicKey3
    ], 2, 'testnet');
    const p2shUtxoWith1BTC = {
      ...
      txId: 'a477af6b2667c29670467e4e0728b685ee07b240235771862318e29ddbe58458',
      outputIndex: 0,
      script: LtzcoreLib.Script(p2shAddress).toString(),
      satoshis: 1e8
    };

    const p2wshAddress = LtzcoreLib.Address.createMultisig([
      p2shPublicKey1,
      p2shPublicKey2,
//      p2shPublicKey3
    ], 2, 'testnet', null, LtzcoreLib.Address.PayToWitnessScriptHash);
    const p2wshUtxoWith1BTC = {
      address: p2wshAddress.toString(),
      txId: 'a477af6b2667c29670467e4e0728b685ee07b240235771862318e29ddbe58458',
      outputIndex: 0,
      script: LtzcoreLib.Script(p2wshAddress).toString(),
      satoshis: 1e8
    };
...
const signedTxp = {"actions":[{"version":"1.0.0","createdOn":1588099987,"copayerId":"671fee02a6c1c4de2e2609f9f9a6180dc03acfff6b759fe0b13a616ed4880065","type":"accept","signatures":["3045022100ace0efb22eaf21b77d5e4a31a491ad06fbcfe700ace5abe8453ec0328c714cba02205090a44975d4b65b5e2f4473da038e83875826b369fc79558a741268ed574bb0"],"xpub":"xpub6DVmxcjRgZdHNSEcXSiFtweVwMSTc3TMwRJ45nJYvyqvLbK1poPerupqh87rSoz27wvckb1CKnGZoLmLXSZyNGZtVd7neqSvdwJL6fceQpe","comment":null}],"version":3,"createdOn":1588099987,"id":"7cea0d95-3308-48e7-a4be-3f16d66e1f5a","walletId":"7eaf4d32-c2fd-4262-864a-4c42fc9236f8","creatorId":"671fee02a6c1c4de2e2609f9f9a6180dc03acfff6b759fe0b13a616ed4880065","coin":"btc","network":"livenet","outputs":[{"amount":80000000,"toAddress":"18PzpUFkFZE8zKWUPvfykkTxmB9oMR8qP7"}],"amount":80000000,"message":"some message","payProUrl":null,"changeAddress":{"version":"1.0.0","createdOn":1588099987,"address":"1FUzgKcyPJsYwDLUEVJYeE2N3KVaoxTjGS","walletId":"7eaf4d32-c2fd-4262-864a-4c42fc9236f8","isChange":true,"path":"m/1/0","publicKeys":["02129acdcc600694b3ce55a2d05244186e806174eb0bafde20e5a6395ded647857"],"coin":"btc","network":"livenet","type":"P2PKH","hasActivity":null,"beRegistered":null},"inputs":[{"txid":"4e7feb01fb039f3a719e9390c8f7cb501fb8a0a083f72a43b4cbb420d8505cc0","vout":5,"satoshis":100000000,"scriptPubKey":"76a914d391e62337ed194a1e428f32d14838e5d848180a88ac","address":"3QQLmrhrreSWhNMxvxEEz8Eodyjpvhgoxu","confirmations":44,"publicKeys":["024d27ca79a3ed27a143cb9d1dff01e4e6445294679a700ca404ca449211d08aa7"],"wallet":"7eaf4d32-c2fd-4262-864a-4c42fc9236f8","path":"m/0/1"}],"walletM":1,"walletN":1,"requiredSignatures":1,"requiredRejections":1,"status":"accepted","txid":"8541ed35ac43e07e362a00ebab9448eefa63840c75ca38edff6785c223503a29","broadcastedOn":null,"inputPaths":["m/0/1"],"outputOrder":[1,0],"fee":2430,"feeLevel":null,"feePerKb":10000,"excludeUnconfirmedUtxos":false,"addressType":"P2PKH","customData":null,"proposalSignature":"3045022100e8a1ac6eef882fb3e7311c725093317df99e5ed46f52fdee9064560bb757d1c902200b09f806a17d4c7950097b8714293725ce741c6de25914f81a8ca0ca1107fc4c","signingMethod":"ecdsa","proposalSignaturePubKey":null,"proposalSignaturePubKeySig":null,"lockUntilBlockHeight":null,"from":null,"derivationStrategy":"BIP44","creatorName":"copayer 1","raw":"","isPending":true};
