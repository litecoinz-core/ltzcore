...
describe('Transaction Model', function() {
  ...
  it('should stream all the mint operations', async () => {
    const tx = ltzcoreLib.Transaction(TransactionFixture.transaction) as BitcoinTransaction;
    let batches = 0;
  ...
  describe('Wallet Tagging', async () => {
    const tx = ltzcoreLib.Transaction(TransactionFixture.transaction) as TaggedBitcoinTx;
    const CURRENT_HEIGHT = 8534;
    ...
    it('should tag the transaction ops, and calculate the fee', async () => {
      function getCoinForInput(i: TransactionInput) {
        ...
        const inputTx = new ltzcoreLib.Transaction(fixtureInput) as BitcoinTransaction;
