...
```javascript
> var ltzcore = require('ltzcore');

// compressed public key starting with 0x03 (greater than midpoint of curve)
> var compressedPK = ltzcore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new ltzcore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = ltzcore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
