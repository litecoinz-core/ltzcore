...
The errors are listed in the generated file in the [errors folder](https://github.com/bitpay/ltzcore/tree/master/packages/ltzcore-lib-cash/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/bitpay/ltzcore/blob/master/packages/ltzcore-lib-cash/lib/errors/spec.js).
