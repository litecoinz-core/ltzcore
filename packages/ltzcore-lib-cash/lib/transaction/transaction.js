 ...
 * and a slightly fancier format recognized by ltzcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a ltzcore Address object. The
 * same is true for `script`, which can be a string or a ltzcore Script.
 *
