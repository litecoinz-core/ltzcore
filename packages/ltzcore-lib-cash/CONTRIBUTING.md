...
We're working hard to make *ltzcore* the most powerful JavaScript library for working with bitcoin. Our goal is to have *ltzcore* be a library that can be used by anyone interested in bitcoin, and to level expertise differences with great design and documentation.

## Community

If there are any questions, etc., please feel to ask in one of the community channels:

- https://labs.bitpay.com/c/ltzcore (Support Forum)
- https://gitter.im/bitpay/ltzcore (Development Chat)
...
These are some global design goals in ltzcore that any change must adhere.
...
When possible, ltzcore objects should have standard methods on an instance prototype:
...
#### T3 - Require 'ltzcore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the ltzcore object.

DO:

```javascript
var ltzcore = require('../');
var PublicKey = ltzcore.PublicKey;
```
...
```sh
git remote add bitpay git@github.com:bitpay/ltzcore.git
...
Finally go to [github.com/bitpay/ltzcore](https://github.com/bitpay/ltzcore) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of ltzcore.

If you have any questions feel free to post them to
[github.com/bitpay/ltzcore/issues](https://github.com/bitpay/ltzcore/issues).
