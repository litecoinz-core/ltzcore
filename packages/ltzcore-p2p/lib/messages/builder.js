...
function builder(options) {
  ...
  if (!options.network) {
    options.network = ltzcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || ltzcore.Block;
  options.BlockHeader = options.BlockHeader || ltzcore.BlockHeader;
  options.Transaction = options.Transaction || ltzcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || ltzcore.MerkleBlock;
