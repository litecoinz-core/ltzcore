...
export class Key {
  ...
  constructor(
    ...
    switch (opts.seedType) {
      ...
      case 'extendedPrivateKey':
        ...
        let xpriv;
        try {
          xpriv = new Ltzcore.HDPrivateKey(x);
        } catch (e) {
  ...
  get = function (password) {
    ...
    if (this.isPrivKeyEncrypted()) {
      ...
      try {
        ...
        if (!this.fingerPrint) {
          let xpriv = new Ltzcore.HDPrivateKey(keys.xPrivKey);
          this.fingerPrint = xpriv.fingerPrint.toString('hex');
  ...
  createCredentials = function (password, opts) {
    ...
    if (opts.network == 'testnet') {
      ...
      xPrivKey = new Ltzcore.HDPrivateKey(x);
    }
  ...
  createAccess = function (password, opts) {
    ...
    var requestPrivKey = new Ltzcore.PrivateKey(opts.requestPrivKey || null);
  ...
  sign = function (rootPath, txp, password, cb) {
    ...
    var xpriv = new Ltzcore.HDPrivateKey(derived);
