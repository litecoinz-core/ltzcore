...
var Ltzcore = require('crypto-wallet-core').LtzcoreLib;
...
describe('Utils', () => {
  ...
  describe('#privateKeyToAESKey', () => {
    it('should be ok', () => {
      var privKey = new Ltzcore.PrivateKey('09458c090a69a38368975fb68115df2f4b0ab7d1bc463fc60c67aa1730641d6c').toString();
  ...
  describe('#verifyRequestPubKey', () => {
    it('should generate and check request pub key', () => {
      var reqPubKey = (new Ltzcore.PrivateKey).toPublicKey();
      var xPrivKey = new Ltzcore.HDPrivateKey();
      var xPubKey = new Ltzcore.HDPublicKey(xPrivKey);
    ...
    it('should fail to check a request pub key with wrong key', () => {
      ...
      var xPrivKey2 = new Ltzcore.HDPrivateKey();
      var xPubKey2 = new Ltzcore.HDPublicKey(xPrivKey2);
