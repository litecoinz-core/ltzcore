...
var HDPrivateKey = ltzcore.HDPrivateKey;
var HDPublicKey = ltzcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = ltzcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(ltzcore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(ltzcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      ltzcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = ltzcore.PublicKey.fromPoint;
      ltzcore.PublicKey.fromPoint = function() {
        ltzcore.PublicKey.fromPoint = unstubbed;
